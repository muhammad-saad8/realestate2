...
if( !empty( $agency_skype ) || !empty( $agency_facebook ) || !empty( $agency_instagram ) || !empty( $agency_line_id ) || !empty( $agency_twitter ) || !empty( $agency_linkedin ) || !empty( $agency_googleplus ) || !empty( $agency_youtube ) || !empty( $agency_pinterest ) || !empty( $agency_vimeo ) || !empty( $agency_whatsapp ) || !empty( $agency_tiktok ) || !empty( $agency_telegram ) ) {
?>
