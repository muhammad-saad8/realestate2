	...
	foreach ($buttonsComposer as $key=>$value) {
		...
		if( $key == 'call' ) {
			$agent_mobile = $listing_agent_info['agent_mobile'] ?? '';
			 if( $agent_mobile != '' ) { $i ++;
			 	?>
			 	<button type="button" class="btn hz-call-popup-js btn-primary-outlined" data-model-id="call-action-<?php echo esc_attr($post->ID); ?>">
			...
			if( $agent_email != '' ) { $i ++;
				?>
				<button type="button" class="btn hz-email-popup-js btn-primary-outlined" data-model-id="email-popup-<?php echo esc_attr($post->ID); ?>">
			...
			if( $agent_whatsapp != '' ) { $i ++;
				...
				?>
				<a class="btn btn-primary-outlined" target="_blank" href="https://api.whatsapp.com/send?phone=<?php echo esc_attr( $agent_whatsapp_call ); ?>&text=<?php echo houzez_option('spl_con_interested', "Hello, I am interested in").' ['.get_the_title().'] '.get_permalink(); ?> ">
			...
			if( $agent_lineapp != '' ) { $i ++;
				?>
				<a class="btn btn-primary-outlined" target="_blank" href="https://line.me/ti/p/~<?php echo esc_attr( $agent_lineapp ); ?>">
			...
			if( $agent_telegram != '' ) { $i ++;
				?>
				<a class="btn btn-primary-outlined" target="_blank" href="<?php echo houzezStandardizeTelegramURL($agent_telegram); ?>">
